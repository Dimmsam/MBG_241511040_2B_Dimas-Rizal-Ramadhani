...
<head>
    ...
    <title>Daftar Permintaan - Sistem MBG</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('gudang.permintaan.index') }}">Permintaan</a>
                    </li>
                </ul>
    ...
    <div class="container-fluid mt-4">
        <h2 class="mb-4">Daftar Permintaan Bahan dari Dapur</h2>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-sm table-borderless mb-2">
                                ...
                                <tr>
                                    <td><strong>Tanggal Masak</strong></td>
                                    ...
                                    <tbody>
                                        @foreach($item->details as $index => $detail)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($detail->bahan)
                                                        <span class="badge bg-{{ $detail->bahan->jumlah >= $detail->jumlah_diminta ? 'success' : 'danger' }}">
                                                            {{ $detail->bahan->jumlah }} {{ $detail->bahan->satuan }}
                                                        </span>
                                                    @else
            ...
            @empty
                <div class="col-12">
                    <div class="alert alert-info">
                        Belum ada permintaan dari dapur
                    </div>
                </div>
            @endforelse
        </div>
